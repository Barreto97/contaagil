          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-20 items-center">
              ...
              <div className="hidden md:flex items-center gap-8">
                <a href="#servicos" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors relative group">
                  Serviços
                ...
                <a href="#sobre" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors relative group">
                  Sobre
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-emerald-600 dark:bg-emerald-400 group-hover:w-full transition-all duration-300"></span>
                </a>
                <a href="#contato" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors relative group">
                  Contato
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-emerald-600 dark:bg-emerald-400 group-hover:w-full transition-all duration-300"></span>
                </a>
            ...
            {isMenuOpen && (
              ...
              >
                <div className="px-4 py-6 space-y-4">
                  <a href="#servicos" className="block text-sm font-medium py-3 px-4 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" onClick={() => setIsMenuOpen(false)}>Serviços</a>
                  <a href="#sobre" className="block text-sm font-medium py-3 px-4 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" onClick={() => setIsMenuOpen(false)}>Sobre</a>
                  <a href="#contato" className="block text-sm font-medium py-3 px-4 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" onClick={() => setIsMenuOpen(false)}>Contato</a>
                  <button className="w-full bg-emerald-600 dark:bg-emerald-500 text-white px-6 py-4 rounded-xl text-sm font-semibold hover:bg-emerald-700 dark:hover:bg-emerald-600 transition-all mt-4">
                    Fale Conosco
                  </button>
                </div>
              </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <button className="inline-flex items-center gap-2 text-emerald-600 dark:text-emerald-400 text-sm font-semibold group-hover:gap-3 transition-all">
                    Saiba mais 
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <h2 className="text-4xl lg:text-5xl font-bold mb-8 leading-tight text-slate-900 dark:text-white">
                  Liderança feminina com foco em <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-emerald-600">resultados reais</span>
                </h2>
                  ...
                  <div className="space-y-8">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <a href="#" className="inline-flex items-center gap-1 text-sm text-emerald-600 dark:text-emerald-400 mt-2 hover:gap-2 transition-all">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-2xl text-slate-900 dark:text-white font-bold">(69) 3421-1908</p>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-lg text-slate-900 dark:text-white font-medium">contato@contaagil.com.br</p>
                    ...
                    <form className="space-y-4">
                      <div>
                        <input 
                          ...
                          className="w-full px-4 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all backdrop-blur-sm"
                        />
                      </div>
                      <div>
                        <input 
                      ...
                      <div>
                        <textarea 
                          ...
                          rows={4}
                          className="w-full px-4 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all backdrop-blur-sm resize-none"
                        ></textarea>
                      </div>
                      <motion.button 
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        type="submit"
                        className="w-full bg-white text-emerald-600 py-5 rounded-xl font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-2 group shadow-xl"
                      >
                        Enviar Mensagem
                        <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                      </motion.button>
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-16">
              <div className="col-span-2">
                ...
                <div className="flex items-center gap-4 mt-6">
                  {['facebook', 'instagram', 'linkedin'].map((social, i) => (
                    ...
                    >
                      <span className="text-slate-600 dark:text-slate-300 group-hover:text-white text-xs font-bold uppercase">{social[0]}</span>
                    </a>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li><a href="#" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Início</a></li>
                  <li><a href="#servicos" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Serviços</a></li>
                  <li><a href="#sobre" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Sobre Nós</a></li>
                  <li><a href="#contato" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Contato</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li><a href="#" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Privacidade</a></li>
                  <li><a href="#" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Termos de Uso</a></li>
                  <li><a href="#" className="text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all" /> Cookies</a></li>
                </ul>
              </div>
            </div>
